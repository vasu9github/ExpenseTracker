...
  const navigate = useNavigate(); // We can actually remove this 'navigate' import too

  const handleSubmit = async (e) => {
    e.preventDefault();
    setIsLoading(true);

    // This call updates the 'token' state in AuthContext.
    // App.jsx will see the new token and redirect automatically.
    await signup(name, email, password);

    // No need for 'if (success)' or 'navigate("/")'
    
    setIsLoading(false);
  };
...
          src="https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop"
*          alt="Person tracking expenses"
        />
        <div className="absolute inset-0 bg-gray-900 opacity-60" />
Click        <div className="absolute inset-0 flex items-center justify-center p-12">
